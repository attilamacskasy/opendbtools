...
#>
param(
    [string]$Source      = 'C:\Users\Attila\Desktop\Code\opendbtools\',
    [string]$Destination = '\\172.22.22.247\c$\Users\Administrator\Desktop\Code\opendbtools',
    [string]$LogDir      = 'C:\Users\Attila\Desktop\Code\opendbtools\rclone-deploy\log',
